...
const CoinPage = () => {
  const { id } = useParams();// getting the coin id from the current route
  ...
  const useStyles = makeStyles((theme) => ({
    ...
    sidebar: {
      width: "30%",
      [theme.breakpoints.down("md")]: {
        width: "100%",             //in medium screen full page coin info is shwon(responsiveness)
      },
      display: "flex",
      flexDirection: "column",
      alignItems: "center",
          ...
          {user && (
            <Button
              ...
              style={{
                width: "100%",
                height: 40,
                backgroundColor: inWatchlist ? "#50C878" : "#FF5733",
              }}
